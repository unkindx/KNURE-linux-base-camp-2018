...
#define MODULE_TAG      "seconds count module "
#define PROC_DIRECTORY  "sec"
#define PROC_FILENAME   "read_sec"
...
static int example_read(struct file *file_p, char __user *buffer, size_t length, loff_t *offset)
{
    ...
    printk(KERN_NOTICE MODULE_TAG "%u seconds left from last read\n", sec);
	sec = 0;
